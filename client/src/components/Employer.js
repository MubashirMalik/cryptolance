    ...
    return (
        <div className="h-screen max-w-screen grid grid-flow-col grid-cols-4 gap-4">
            <div className="w-58 bg-slate-800 pt-10 col-span-1">
                <Link to="/freelancer" className="flex justify-start items-center hover:bg-slate-700 pl-4 p-2">
                    <SiFreelancer className="text-4xl text-slate-500" />
                    <h2 className="text-white font-medium">Become a Freelancer</h2>
                </Link>
                <Link to="/employer" className="flex justify-start items-center bg-slate-600 pl-4 p-2">
            ...
            </div>
            {
                connected ? <div className="bg-slate-900 col-span-3">
                    ...
                    <form action="" method="post" className="w-full">
                        <div class="form-control p-10 pr-20 pl-20">
                            <label class="label">
                                <span class="label-text">Full Name</span>
                            </label>
                            <input type="text" placeholder="Shahmeer Mehmood" class="input input-bordered w-full max-w-screen" value={fname} onChange={(e) => setFname(e.target.value)} />
                            <label class="label">
                                <span class="label-text">Wallet Address</span>
                            </label>
                            <input type="text" disabled class="input input-bordered w-full max-w-screen" value={walletAddress} />
                            <label class="label">
                                <span class="label-text">Primary Language</span>
                            </label>
                            <select class="select select-bordered" value={language} onChange={(e) => setLanguage(e.target.value)}>
                            ...
                            <select class="select select-bordered" value={country} onChange={(e) => setCountry(e.target.value)}>
                            ...
                            <textarea class="textarea textarea-bordered" cols={5} rows={5} placeholder="Tell us a little about yourself" value={bio} onChange={(e) => setBio(e.target.value)} />
                        </div>
