    ...
    return (
        <div className="max-w-screen grid grid-flow-col grid-cols-4">
            <div className="w-50 bg-slate-800 pt-10 col-span-1 min-h-screen">
               <SideBarNav viewType="Freelancer" connection={connection} />
            </div>
            {
                connection.account ? 
                    <div className="bg-slate-900 col-span-3 new-bg">
                        <h1 className="pl-10 pt-10 text-3xl font-bold underline text-center">Choose from List of Posted Projects</h1>
                        { projects.length === 0 ?
